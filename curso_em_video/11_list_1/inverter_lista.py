...
for i in range(len(lista) // 2):
    # len é // 2 porque o for só precisa percorrer metade da lista para trocar
    # os valores
    auxiliar = lista[i]  # auxiliar = 1
    lista[i] = lista[indice_fim_lista]
    # Substituí o primeiro valor da lista (1) pelo último (15),
    # então lista[0] = 15
    lista[indice_fim_lista] = auxiliar
    # substituí o último valor da lista pelo valor da variável auxiliar (1),
    # então lista[14] = 1
